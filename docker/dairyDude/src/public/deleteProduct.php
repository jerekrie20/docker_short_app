...
if(isset($_SESSION['validUser']) && $_SESSION['validUser'] == true){
    ...
    try{
        $sql = "SELECT * FROM dairydude_merch ";
...
<head>
    ...
    <script>
        function deleteProduct(productId){
            let getUser = document.querySelector("#userInput").value;
            let confReply = confirm("Are you sure that you want to delete this product? There's no way to reverse this decision");
            if(getUser == ""){
                if(confReply){
                window.location.replace("deleteSelected.php?merchId=" +productId);
             }else{
                window.location.replace("deleteProduct.php");
            }
            }else{
        ...
        ?>
            <div class="merchBlock">
                <div class="merchImage">
                    ...
                    <p class="merchButton"><?php echo $result['merch_button'];?></p>
                    <p class="merchPdf">Pdf: <?php echo $result['merch_pdf'];?></p>
                    <form >
                        <p class="userInput" style="display: none;" >
                            <label for="user_input">User</label>
                            <input type="text" name="user_input" id="userInput" value="">
                        </p>       
                    </form>
                    <button onclick="deleteProduct( <?php echo $result['merch_id'];?>)">Delete</button>
                    </div>                                                                                                            <?php
                }       //end of foreach
                ?>
