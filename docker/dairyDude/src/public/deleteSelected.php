...
if(isset($_SESSION['validUser']) && $_SESSION['validUser'] == true){
    ...
    $deleteId = $_GET['merchId'];


    try{
        $sql = "DELETE FROM dairydude_merch WHERE merch_id=:merchId ";
        $stmt = $conn->prepare($sql);
        $stmt->bindParam(":merchId",$deleteId);
...
<body>
    ...
    <?php
        if($numDeletes >0){
            ...
            <div class="deleteResult">
                <h2>The merch was succesfully deleted</h2>
                <a href="deleteProduct.php"><button class="button2">Delete Another</button></a>
    ...
    <div class="deleteResult">
                ...
                <a href="deleteProduct.php"><button class="button2">Try Again</button></a>
                <a href="logout.php"> <button class="button3">logout</button></a>
            </div>
